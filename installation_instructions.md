...
Ce guide vous explique comment installer AuroriaLink sur différents systèmes d'exploitation.
...
1.  **Téléchargez l'archive `windows.zip`** depuis le lien des [dernières versions](https://github.com/Sebastien-VZN/auroria_link/releases/latest).
